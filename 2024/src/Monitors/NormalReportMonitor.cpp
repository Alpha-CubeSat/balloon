...
void NormalReportMonitor::execute()
{
    ...
    uint8_t temperature_interior = map(sfr::temperature::temp1_c_value, constants::temperature::min_temp_c, constants::temperature::max_temp_c, 0, 255);
    uint8_t temperature_exterior = map(sfr::temperature::temp2_c_value, constants::temperature::min_temp_c, constants::temperature::max_temp_c, 0, 255);
    ...
    sfr::rockblock::report[9] = temperature_interior;
    sfr::rockblock::report[10] = temperature_exterior;
    sfr::rockblock::report[11] =  sfr::rockblock::signal_strength;
}